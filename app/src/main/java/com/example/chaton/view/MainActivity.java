package com.example.chaton.view;
...
import com.example.chaton.menu.CallsFragment;
import com.example.chaton.menu.CameraFragment;
import com.example.chaton.menu.ChatsFragment;
import com.example.chaton.menu.StatusFragment;
import com.example.chaton.view.activities.contact.ContactsActivity;
import com.example.chaton.view.activities.settings.SettingsActivity;
import com.example.chaton.view.activities.status.AddStatusPicActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.action_new_group :  Toast.makeText(MainActivity.this, "Action New Group", Toast.LENGTH_SHORT).show(); break;
            case R.id.action_new_broadcast :  Toast.makeText(MainActivity.this, "Action New Broadcast", Toast.LENGTH_SHORT).show(); break;
            case R.id.action_wa_web :  Toast.makeText(MainActivity.this, "Action Web", Toast.LENGTH_SHORT).show(); break;
            case R.id.action_starred_message :  Toast.makeText(MainActivity.this, "Action Starred Message", Toast.LENGTH_SHORT).show(); break;
