package com.example.chaton.view.activities.chats;
...
import com.example.chaton.adapter.ChatsAdapder;
import com.example.chaton.databinding.ActivityChatsBinding;
import com.example.chaton.interfaces.OnReadChatCallBack;
...
import com.example.chaton.view.activities.dialog.DialogReviewSendImage;
import com.example.chaton.view.activities.profile.UserProfileActivity;
...
public class ChatsActivity extends AppCompatActivity {
    ...
    private void startRecord(){
        ...
        try {
            ...
            mediaRecorder.start();
            //  Toast.makeText(InChatActivity.this, "Recording...", Toast.LENGTH_SHORT).show();
        } catch (IOException e) {
            e.printStackTrace();
            Toast.makeText(ChatsActivity.this, "Recording Error , Please restart your app ", Toast.LENGTH_SHORT).show();
        }
